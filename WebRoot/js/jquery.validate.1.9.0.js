 ...
 *   	rangelength: jQuery.validator.format("长度介于 {0} 和 {1} 之间的字符"),
 ...
 *   	phone: "请输入合法的手机号码",
 *   	chinese: "只能输入中文汉字",
 *   	english: "只能输入字母[a-zA-Z]",
 *   	englishnum: "只能输入字母或数字[a-zA-Z0-9]",
 *   	chinesefull: "只能包括中文汉字、英文字母、数字和下划线"
 *   }
 *   
 */
(function($) {
...
$.extend($.validator, {
	...
	classRuleSettings: {
		...
		englishnum: {englishnum: true},
		chinese: {chinese: true},
		chinesefull: {chinesefull: true}
	},
	...
	methods: {
		...
		// chinesefull definition
		chinesefull: function(value, element) {
			return this.optional(element) || /^[\u0391-\uffe5\w]+$/.test(value);
		},
		
		// englishnum definition
		englishnum: function(value, element) {
			return this.optional(element) || /^[0-9a-zA-Z]*$/.test(value);
		},
		
		// phone definition
		phone: function(value, element) {
			return this.optional(element) || /^(13|14|15|18)[0-9]{9}$/.test(value);
		},
